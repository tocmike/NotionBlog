...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Mike', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '佛系Blog', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://to.com', // 网站地址
